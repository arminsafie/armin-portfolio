            ...
            <div class="row gx-5 align-items-center">
                    ...
                    <div class="text-center text-xxl-start">
                        ...
                        >
                            <div class="text-uppercase">
                                Innovative &middot; Dynamic &middot; Responsive
                            </div>
                        </div>
                ...
                <div class="col-xxl-7">
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile">
                            <img class="profile-img" src="{{ asset("assets/client/img/armin.jpg") }}" alt="..." />
                            <div class="dots-1">
                                <svg
                                    version="1.1"
                ...
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="text-muted">
                            ...
                            and highly responsive websites that seamlessly adapt to
                            various devices and screen sizes. Additionally, my proficiency
                            in Laravel PHP allows me to create dynamic and feature-rich
                            web applications with efficiency and scalability in mind. With
                            a keen eye for detail and a passion for clean, maintainable
                            code, I am dedicated to delivering exceptional digital
                            experiences that exceed client expectations.
                        </p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a
                                class="text-gradient"
                                href="https://www.linkedin.com/in/armin-safaie-8a884b2b2/"
                            ><i class="bi bi-linkedin"></i
                                ></a>
                            <a class="text-gradient" href="#!"
                            ><i class="bi bi-telegram"></i
                                ></a>
                            <a class="text-gradient" href="https://github.com/arminsafie"
